...
from keras.layers import Dense, Flatten, Lambda, Cropping2D, Conv2D, MaxPooling2D, Activation, BatchNormalization
...
#data = pd.read_csv("../data/recording/driving_log.csv")
#print(data.columns)
...
print(train_data.head(n=2))
print(test_data.head(n=2))
partition = {}
